...
--
-- Host: localhost
-- Generation Time: Mar 12, 2024 at 10:01 PM
...
CREATE TABLE `servicios` (
  ...
  `pol_cancel` varchar(255) NOT NULL,
  `misc` text NOT NULL,
  `inmersiones` int(10) NOT NULL,
  `image_url` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
