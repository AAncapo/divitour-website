      ...
      <div id="contacts" class="container d-flex" style="margin-bottom: 100px;flex-direction:column">
        ...
        <div class="contact-items">
          <span class="contact-item">
            <img src=<?php echo $base_url . 'images/icons/whatsapp.png'; ?> /><a
          ...
          <div class="social-media">
            <span class="contact-item">
              ...
              ><img src=<?php echo $base_url . 'images/icons/icons8-facebook.png'; ?> /></a>
            </span>
            <span class="contact-item">
              <a href="https://www.instagram.com/divitourtravel/" target="_blank"
              ><img src=<?php echo $base_url . 'images/icons/icons8-instagram.png'; ?> /></a>
            </span>
          </div>
        </div>
      </div>
