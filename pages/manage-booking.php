                    ...
                    <div class="row h-100 justify-content-center gap-3">
                        ...
                        <form class="col rounded" action="" method="post">
                            <div class="d-block d-md-flex gap-4 m-0 py-3 rounded align-items-center">  
                                ...
                                <span class="d-flex gap-1"><p>Cost: </p><p id="baseCost"><?php echo ' '. $row['base_cost'] ?></p>EUR</span>
                                <span class="d-flex gap-1"><p>Cost:<p id="overCost"><?php echo $row['over_cost'] ?></p><p>EUR</p> after</p><p id="baseLimit"><?php echo $row['base_pax_limit'] ?></p>passengers.</p></span>
